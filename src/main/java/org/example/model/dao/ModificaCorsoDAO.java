...
public class ModificaCorsoDAO implements GenericProcedureDAO {
    ...
    public Object execute(Object... params) throws DAOException, SQLException {
        ...
        try (Connection conn = ConnectionFactory.getConnection();
            ...
            if (corso.getMinimo() != null)    cs.setObject(2, corso.getMinimo(),    Types.INTEGER);
            ...
            if (corso.getCosto() != null)     cs.setObject(5, corso.getCosto(),     Types.INTEGER);
            ...
            if (corso.getCapienza() != null)  cs.setObject(8, corso.getCapienza(),   Types.INTEGER);
